...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.mGuru.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.m-gurus.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('mulai_bekerja') ? 'is-invalid' : '' }}" type="text" name="mulai_bekerja" id="mulai_bekerja" value="{{ old('mulai_bekerja') }}" required>
